...
Please refer to the [bootstrap instructions](https://github.com/ericr3r/notes-superbird/bootstrapping.md) in the [ericr3r/notes-superbird](https://github.com/ericr3r/notes-superbird) repository.
